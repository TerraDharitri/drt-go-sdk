...
import (
	...
	sdkHttp "github.com/TerraDharitri/drt-go-sdk/core/http"
...
func TestGetAccount(t *testing.T) {
	...
	address, err := data.NewAddressFromBech32String("drt1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpstfdrqw")
	if err != nil {
		assert.Error(t, err)
	}
...
func TestProxy_GetNetworkEconomics(t *testing.T) {
	...
	responseBytes := []byte(`{"data":{"metrics":{"drt_dev_rewards":"0","drt_epoch_for_economics_data":263,"drt_inflation":"5869888769785838708144","drt_total_fees":"51189055176110000000","drt_total_staked_value":"9963775651405816710680128","drt_total_supply":"21556417261819025351089574","drt_total_top_up_value":"1146275808171377418645274"}},"code":"successful"}`)
...
func TestProxy_RequestTransactionCost(t *testing.T) {
	...
	tx := &transaction.FrontendTransaction{
		Nonce:    1,
		Value:    "50",
		Receiver: "drt1rh5ws22jxm9pe7dtvhfy6j3uttuupkepferdwtmslms5fydtrh5smd3qya",
		Sender:   "drt1rh5ws22jxm9pe7dtvhfy6j3uttuupkepferdwtmslms5fydtrh5smd3qya",
		Data:     []byte("hello"),
		ChainID:  "1",
		Version:  1,
		Options:  0,
...
func TestProxy_GetTransactionInfoWithResults(t *testing.T) {
	...
	responseBytes := []byte(`{"data":{"transaction":{"type":"normal","nonce":22100,"round":53057,"epoch":263,"value":"0","receiver":"drt1e6c9vcga5lyhwdu9nr9lya4ujz2r5w2egsfjp0lslrgv5dsccpdsxlwe0r","sender":"drt1e6c9vcga5lyhwdu9nr9lya4ujz2r5w2egsfjp0lslrgv5dsccpdsxlwe0r","gasPrice":1000000001,"gasLimit":19210000,"data":"","signature":"37922ccb13d46857d819cd618f1fd8e76777e14f1c16a54eeedd55c67d5883db0e3a91cd0ff0f541e2c3d7347488b4020c0ba4765c9bc02ea0ae1c3f6db1ec05","sourceShard":1,"destinationShard":1,"blockNonce":53052,"blockHash":"4a63312d1bfe48aa516185d12abff5daf6343fce1f298db51291168cf97a790c","notarizedAtSourceInMetaNonce":53053,"NotarizedAtSourceInMetaHash":"342d189e36ef5cbf9f8b3f2cb5bf2cb8e2260062c6acdf89ce5faacd99f4dbcc","notarizedAtDestinationInMetaNonce":53053,"notarizedAtDestinationInMetaHash":"342d189e36ef5cbf9f8b3f2cb5bf2cb8e2260062c6acdf89ce5faacd99f4dbcc","miniblockType":"TxBlock","miniblockHash":"0c659cce5e2653522cc0e3cf35571264522035a7aef4ffa5244d1ed3d8bc01a8","status":"success","hyperblockNonce":53053,"hyperblockHash":"342d189e36ef5cbf9f8b3f2cb5bf2cb8e2260062c6acdf89ce5faacd99f4dbcc","smartContractResults":[{"hash":"5ab14959aaeb3a20d95ec6bbefc03f251732d9368711c55c63d3811e70903f4e","nonce":0,"value":0,"receiver":"drt1qqqqqqqqqqqqqpgqtjp7p3pwmn3efaqtynff62vtqfyug8cz396qdgmsn6","sender":"drt1e6c9vcga5lyhwdu9nr9lya4ujz2r5w2egsfjp0lslrgv5dsccpdsxlwe0r","data":"DCDTNFTTransfer@595959453643392d303934393030@01@01@080112020001226f08011204746573741a20ceb056611da7c977378598cbf276bc90943a3959441320bff0f8d0ca3618c05b20e8072a206161616161616161616161616161616161616161616161616161616161616161320461626261321268747470733a2f2f6e756d6261742e636f6d3a0474657374@66756e64@57c506a19d8eae1829403a8f3f54e1f0379f38157fcf53d5bca6f237e4a4cf61@1c20","prevTxHash":"c7fadeaccce0673bd6ce3a1f472f7cc1beef20c0b3131cfa9866cd5075816639","originalTxHash":"c7fadeaccce0673bd6ce3a1f472f7cc1beef20c0b3131cfa9866cd5075816639","gasLimit":18250000,"gasPrice":1000000001,"callType":0},{"hash":"f337d2705d2b644f9d8f75cf270e879b6ada51c4c54009e94305adf368d1adbc","nonce":1,"value":102793170000000,"receiver":"drt1e6c9vcga5lyhwdu9nr9lya4ujz2r5w2egsfjp0lslrgv5dsccpdsxlwe0r","sender":"drt1qqqqqqqqqqqqqpgqtjp7p3pwmn3efaqtynff62vtqfyug8cz396qdgmsn6","data":"@6f6b","prevTxHash":"5ab14959aaeb3a20d95ec6bbefc03f251732d9368711c55c63d3811e70903f4e","originalTxHash":"c7fadeaccce0673bd6ce3a1f472f7cc1beef20c0b3131cfa9866cd5075816639","gasLimit":0,"gasPrice":1000000001,"callType":0}]}},"error":"","code":"successful"}`)
	httpClient := createMockClientRespondingBytes(responseBytes)
	args := createMockArgsProxy(httpClient)
	ep, _ := NewProxy(args)
...
func TestProxy_ExecuteVmQuery(t *testing.T) {
	...
	t.Run("no finality check", func(t *testing.T) {
		...
		response, err := ep.ExecuteVMQuery(context.Background(), &data.VmValueRequest{
			Address:    "drt1qqqqqqqqqqqqqpgqxwakt2g7u9atsnr03gqcgmhcv38pt7mkd94q8vqld4",
			FuncName:   "version",
			CallerAddr: "drt1qqqqqqqqqqqqqpgqxwakt2g7u9atsnr03gqcgmhcv38pt7mkd94q8vqld4",
		})
		require.Nil(t, err)
...
func TestNumbatProxy_GetDCDTTokenData(t *testing.T) {
	t.Parallel()
	...
	t.Run("nil address, should error", func(t *testing.T) {
		...
		tokenData, err := ep.GetDCDTTokenData(context.Background(), nil, token, emptyQueryOptions)
	...
	t.Run("invalid address, should error", func(t *testing.T) {
		...
		tokenData, err := ep.GetDCDTTokenData(context.Background(), address, token, emptyQueryOptions)
		assert.Nil(t, tokenData)
	...
	t.Run("http client errors, should error", func(t *testing.T) {
		...
		tokenData, err := ep.GetDCDTTokenData(context.Background(), validAddress, token, emptyQueryOptions)
		assert.Nil(t, tokenData)
	...
	t.Run("response returned error, should error", func(t *testing.T) {
		...
		response := &data.DCDTFungibleResponse{
	...
	t.Run("should work", func(t *testing.T) {
		...
		responseTokenData := &data.DCDTFungibleTokenData{
		...
		response := &data.DCDTFungibleResponse{
			Data: struct {
				TokenData *data.DCDTFungibleTokenData `json:"tokenData"`
			}{
	...
	t.Run("should work with query options", func(t *testing.T) {
		...
		tokenData, err := ep.GetDCDTTokenData(context.Background(), validAddress, token, testQueryOptions)
		assert.NotNil(t, tokenData)
		assert.Nil(t, err)
		assert.Equal(t, responseTokenData, tokenData)
		assert.False(t, responseTokenData == tokenData) // pointer testing
...
func TestNumbatProxy_GetNFTTokenData(t *testing.T) {
	t.Parallel()
	...
	t.Run("should work", func(t *testing.T) {
		...
		responseTokenData := &data.DCDTNFTTokenData{
			TokenIdentifier: "identifier",
			Balance:         "balance",
			Properties:      "properties",
			Name:            "name",
		...
		response := &data.DCDTNFTResponse{
			Data: struct {
				TokenData *data.DCDTNFTTokenData `json:"tokenData"`
			}{
				TokenData: responseTokenData,
			},
		}
...
func TestProxy_GetGuardianData(t *testing.T) {
	...
	t.Run("should work", func(t *testing.T) {
		...
		address, _ := data.NewAddressFromBech32String("drt1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpstfdrqw")
		response, err := ep.GetGuardianData(context.Background(), address)
		require.Nil(t, err)
...
func TestProxy_FilterLogs(t *testing.T) {
	...
	t.Run("should fail for addresses from different shards", func(t *testing.T) {
		...
		invalidFilter := &sdkCore.FilterQuery{
			FromBlock: core.OptionalUint64{Value: 21000005, HasValue: true},
			ToBlock:   core.OptionalUint64{Value: 21000005, HasValue: true},
			Addresses: []string{"drt1qqqqqqqqqqqqqpgq50dge6rrpcra4tp9hl57jl0893a4r2r72jpstdjq3v", "drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6"},
			ShardID:   core.OptionalUint32{Value: 0, HasValue: false},
			Topics:    nil,
			BlockHash: nil,
		}
	...
	t.Run("should fail if addresses computed shard id differ from provided shardID", func(t *testing.T) {
		...
		invalidFilter := &sdkCore.FilterQuery{
			FromBlock: core.OptionalUint64{Value: 21000005, HasValue: true},
			ToBlock:   core.OptionalUint64{Value: 21000005, HasValue: true},
			Addresses: []string{"drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6"}, // address from shard 0
	...
	t.Run("should work with specific addresses", func(t *testing.T) {
		...
		validFilter := &sdkCore.FilterQuery{
			FromBlock: core.OptionalUint64{Value: 21000005, HasValue: true},
			ToBlock:   core.OptionalUint64{Value: 21000005, HasValue: true},
			Addresses: []string{"drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6"},
			ShardID:   core.OptionalUint32{Value: 0, HasValue: true},
			Topics:    nil,
			BlockHash: nil,
		}
		...
		assert.Equal(t, res[0].Address, "drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6")
		assert.Equal(t, len(res[0].Topics), 1)

		assert.Equal(t, res[1].Identifier, "completedTxEvent")
		assert.Equal(t, res[1].Address, "drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6")
		assert.Equal(t, len(res[1].Topics), 1)

		assert.Equal(t, res[2].Identifier, "completedTxEvent")
		assert.Equal(t, res[2].Address, "drt1d7y4a8wtykxnxxjhywzk0q5tkey4g9z6rhalefw6syr779kh77yqsn73h6")
	...
	t.Run("should work with topics", func(t *testing.T) {
		...
		assert.Equal(t, res[0].Identifier, "DCDTTransfer")
		assert.Equal(t, res[0].Address, "drt1qqqqqqqqqqqqqpgqta0tv8d5pjzmwzshrtw62n4nww9kxtl278ssda3z9z")
	...
	t.Run("should work with specific block hash", func(t *testing.T) {
		...
		assert.Equal(t, res[1].Address, "drt1mmh2j5y8esv2tmmyeau3hr4xa2u2te3zc3j9wumn3v5vm8uvsczqwq03hp")
		assert.Equal(t, len(res[1].Topics), 1)

		assert.Equal(t, res[2].Identifier, "completedTxEvent")
		assert.Equal(t, res[2].Address, "drt1mmh2j5y8esv2tmmyeau3hr4xa2u2te3zc3j9wumn3v5vm8uvsczqwq03hp")
		assert.Equal(t, len(res[2].Topics), 1)

		assert.Equal(t, res[3].Identifier, "completedTxEvent")
		assert.Equal(t, res[3].Address, "drt1mmh2j5y8esv2tmmyeau3hr4xa2u2te3zc3j9wumn3v5vm8uvsczqwq03hp")
	...
	t.Run("should work with caching", func(t *testing.T) {
		...
		assert.Equal(t, res2[0].Identifier, "DCDTTransfer")
		assert.Equal(t, res2[0].Address, "drt15aq4rug5rxjnu88723f2y5fx2w9kzzw2rha89jzfpfhfy9huuxyqg75cv4")
		assert.Equal(t, len(res2[0].Topics), 4)

		assert.Equal(t, res2[1].Identifier, "DCDTLocalBurn")
		assert.Equal(t, res2[1].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
		assert.Equal(t, len(res2[1].Topics), 3)

		assert.Equal(t, res2[2].Identifier, "DCDTTransfer")
		assert.Equal(t, res2[2].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
		assert.Equal(t, len(res2[2].Topics), 4)

		assert.Equal(t, res2[3].Identifier, "DCDTNFTTransfer")
		assert.Equal(t, res2[3].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
		assert.Equal(t, len(res2[3].Topics), 4)

		assert.Equal(t, res2[4].Identifier, "buyOffer")
		assert.Equal(t, res2[4].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
		assert.Equal(t, len(res2[4].Topics), 8)

		assert.Equal(t, res2[5].Identifier, "writeLog")
		assert.Equal(t, res2[5].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
		assert.Equal(t, len(res2[5].Topics), 1)

		assert.Equal(t, res2[6].Identifier, "completedTxEvent")
		assert.Equal(t, res2[6].Address, "drt1qqqqqqqqqqqqqpgqstmgzmwfm5q3y3r0gkv0fp3j07chyv69h4vqr86a2n")
