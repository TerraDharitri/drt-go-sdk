...
// GetDCDTTokenData returns the dcdt endpoint
func (base *baseEndpointProvider) GetDCDTTokenData(addressAsBech32 string, tokenIdentifier string) string {
	return fmt.Sprintf(dcdt, addressAsBech32, tokenIdentifier)
}

// GetNFTTokenData returns the NFT/SFT/MetaDCDT endpoint
