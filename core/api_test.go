...
func TestBuildUrlWithAccountQueryOptions_ShouldWork(t *testing.T) {
	builtUrl := BuildUrlWithAccountQueryOptions("/address/drt1alice", api.AccountQueryOptions{})
	...
	// https://github.com/TerraDharitri/drt-go-chain/blob/master/api/groups/addressGroupOptions.go
