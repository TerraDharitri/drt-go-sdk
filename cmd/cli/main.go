...
`
	...
	setGuardian = cli.StringFlag{
		Name:        "setGuardian",
		Usage:       "If used, it fills the data field with formatted setGuardian transaction data for the given guardian address. Options: alice, bob, eve, charlie, drt1..... Could fail with custom address and guardedTx set",
	...
	receiver = cli.StringFlag{
		Name:        "receiver",
		Usage:       "If used, it replaces the default receiver with the given one. Options: alice, bob, eve, charlie, drt1...",
	...
	withFunding = cli.BoolFlag{
		Name:        "withFunding",
		Usage:       "If set the default accounts will be funded with 10 rewa",
	...
	argsConfig = &cfg{}
	log        = logger.GetOrCreate("drt-go-sdk/cmd/cli")
)

var homePath = os.Getenv("HOME")
var pathGeneratedWallets = homePath + "/Dharitri/testnet/filegen/output/walletKey.pem"
...
func main() {
	...
	app.Name = "cli"
	app.Version = "v1.0.0"
	app.Usage = "This binary provides commands to interact with the Dharitri blockchain"
...
func sendFundWalletsTxs(td *testData, proxy workflows.ProxyHandler, providedTx transaction.FrontendTransaction, receivers []core.AddressHandler) error {
	...
	providedTx.Value = "10000000000000000000" // 10REWA
