...
func TestSigner_SignTransaction(t *testing.T) {
	...
	t.Run("should work with signature generated using sdk-js", func(t *testing.T) {
		...
		require.Nil(t, err)
		msg := []byte("message")
		sig, _ := hex.DecodeString("c344fd7d86e1c0352bd59ff49b0e7c05bc29a826aa6616884897e0dd9fbfb865eebaf578e90042165472ea20d7f7a27361bb5e16fccd0dd33a83f7034bb80b00")
